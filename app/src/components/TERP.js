...
export default class TERP extends Component {
  ...
  componentDidMount() {
    axios.get('https://sandbox.iexapis.com/stable/stock/TERP/quote?token=Tpk_521edcea4a3542dca944cb368cc0ec7b').then((response) => {

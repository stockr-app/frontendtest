...
export default class IRBT extends Component {
  ...
  componentDidMount() {
    axios.get('https://sandbox.iexapis.com/stable/stock/IRBT/quote?token=Tpk_521edcea4a3542dca944cb368cc0ec7b').then((response) => {

...
export default class STZ extends Component {
  ...
  componentDidMount() {
    axios.get('https://sandbox.iexapis.com/stable/stock/STZ/quote?token=Tpk_521edcea4a3542dca944cb368cc0ec7b').then((response) => {
